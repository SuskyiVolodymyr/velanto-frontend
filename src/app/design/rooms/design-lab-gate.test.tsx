...
vi.mock("@/features/design-lab/DesignRoomBetweenScreen", () => ({
  DesignRoomBetweenScreen: () => <div>between</div>,
}));
vi.mock("@/features/design-lab/DesignRoomGuessingScreen", () => ({
  DesignRoomGuessingScreen: () => <div>guessing</div>,
}));
vi.mock("@/features/design-lab/DesignRoomResultsScreen", () => ({
